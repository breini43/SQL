...
--Вывемти только ID пользователей
select id from students;
--Вывести тоьлко имена пользователей
select name from students;
--Вывести тоьлко email пользователей
...
--Вывести пользователей который были созданы 2021-03-26 00:00:00
select * from students 
where created_on = '2021-03-26 00:00:00';
--Вывести пользователей где в имени есть слово Anna
select * from students
where name like 'Anna%';
--Вывести пользователей шде в имени в конце есть 8
select * from students 
where name like '%8';
...
--Вывести пользователей которые были создарны 2021-07-12 00:00:00 и имеют пароль 1m313
select * from students 
...
--Вывести пользователя у которого id равен 120
